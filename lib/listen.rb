  ...
  post '/payload' do
    ...
    begin
      if params[:payload]
        ...
        allow_master = ('closely-common' == repo) || ('closely-common-scripts' == repo) || ('devops' == repo) || ('Utility-Config' == repo) || ('learning-center' == repo) || ('closely-web' == repo)
        if branch.match(/^develop(?:-\w+)/) || (allow_master && 'master' == branch)
